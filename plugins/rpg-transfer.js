            ...
            case 'tabungan':
                if (global.db.data.users[m.sender].bank >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil Mentransfer Tabungan Sebesar ${count}\nSisa Tabungan kamu: 💲${users[m.sender].bank}`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].bank += count * 1
                        m.reply('Gagal Menstransfer *tabungan*')
                        console.log(e)
                        if (DevMode) {
                ...
                } else conn.reply(m.chat, `Tabungan Kamu Tidak Mencukupi Untuk Mentransfer Sebesar ${count}`.trim(), m)
                break
            case 'money':
            ...
            case 'limit':
                if (global.db.data.users[m.sender].limit >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil Mentransfer Limit sebanyak ${count}`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].limit += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else conn.reply(m.chat, `Limit Kamu Tidak Mencukupi Untuk Mentransfer sebanyak ${count}`.trim(), m)
                break
            case 'tabungan':
